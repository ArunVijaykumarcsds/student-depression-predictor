...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("👨‍💻 Developed by: **Arun vk**")
    st.markdown("🔗 GitHub: [Arun vk](https://github.com/ArunVijaykumarcsds)")
    st.markdown("🔗 LinkedIn: [Profile](www.linkedin.com/in/arunvk2004/)")
    st.markdown("---")
